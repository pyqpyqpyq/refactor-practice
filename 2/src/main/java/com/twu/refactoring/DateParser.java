...
public class DateParser {
    ...
    private static final HashMap<String, TimeZone> timeZone = new HashMap<String, TimeZone>();

    static {
        timeZone.put("UTC", TimeZone.getTimeZone("UTC"));
    }
    ...
    public Date parse() {
        ...
        return returnTime(year, month, date, hour, minute);
    }

    private Date returnTime(int year, int month, int date, int hour, int minute) {
    ...
    private int getTime(int start, int end, String stringIndexOutOfBoundsException, String numberFormatException, int min, int max, String illegalArgumentException) {
        int year;
        try {
